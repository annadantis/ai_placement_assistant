        ...
        child: Column(
          ...
          children: [
            ...
            if (responseBreakdown.isNotEmpty) ...[
              ...
              const SizedBox(height: 4),
              Text(
                "Improved & ideal answer for each of your turns",
                style: GoogleFonts.inter(fontSize: 12, color: Colors.white38),
              ),
              const SizedBox(height: 12),
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildComparisonBox("YOU SAID", item['response'] ?? "", Colors.white60, isItalic: true),
                      const SizedBox(height: 8),
                      _buildComparisonBox("IMPROVED", item['improved'] ?? "", Colors.cyanAccent),
                      if ((item['ideal'] ?? "").toString().isNotEmpty) ...[
                        const SizedBox(height: 8),
                        _buildComparisonBox("IDEAL", item['ideal'] ?? "", Colors.greenAccent),
                      ],
                    ],
                  ),
                );
